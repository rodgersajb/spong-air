    ...
    <main className="w-screen  bg-spongWhite text-spongWhite font-semibold  ">
      ...
      <section className="w-screen m-auto py-4 bg-spongLightBrown text-spongBrown font-normal flex flex-col gap-4 min-[400px]">
        ...
        <article className=" w-[95%] m-auto flex flex-col gap-4 pt-8">
          ...
          <h3 className="border-b-2 lg:border-b border-spongBrown pb-2 lg:text-2xl lg:w-1/2"> Precision Craftsmanship</h3>
          ...
          <h3 className="border-b-2 pb-2 lg:border-b lg:border-spongBrown lg:text-2xl lg:w-1/2">Customer-Centered Solutions</h3>
          <p className="text-sm font-light lg:w-1/2 lg:text-lg">
          ...
          <h3 className="border-b-2 pb-2 lg:text-2xl lg:border-b lg:border-spongBrown lg:w-1/2">Sustainability and Efficiency</h3>
          <p className="text-sm font-light lg:w-1/2 lg:text-lg ">
